...
p1+theme_bw()+
  ...
  ylab("Scaled odds ratio estimates")+
...
s_cpta_plot+theme_bw()+
  ...
  ylab("Scaled estimates of disease severity ratio")+
  theme(panel.grid = element_blank(),
        axis.text = element_text(size=10))
